 ...
 */
{
    ...
    class Grid {
        constructor() {
            ...
            // the more/back box
            this.moreCtrl = document.querySelector('.grid__item--more');
            const more = new GridItem(this.moreCtrl);
        ...
        initEvents() {
            ...
            this.moreCtrl.addEventListener('click', () => {
        ...
        toggleProject(action) {
            ...
            this.showRevealer().then(() => {
                this.DOM.fullviewItems[0].style.visibility = "hidden";
                this.DOM.fullviewItems[1].style.visibility = "hidden";
                this.DOM.fullviewItems[2].style.visibility = "hidden";
                this.DOM.fullviewItems[3].style.visibility = "hidden";
                // this.DOM.fullviewItems[4].style.visibility = "hidden";
                // this.DOM.fullviewItems[5].style.visibility = "hidden";
                // this.DOM.fullviewItems[6].style.visibility = "hidden";
                // this.DOM.fullviewItems[7].style.visibility = "hidden";

                this.DOM.fullviewItems[this.current].style.visibility = "visible";
                // this.DOM.fullviewItems[this.current].style.visibility = this.isGridHidden ? "visible" : "hidden";
